...
const VisualsPointsOfSale = () => {
  ...
  return (
    <section id='points-of-sale' className="relative py-20 md:py-32 overflow-hidden bg-gradient-to-br from-green-50 via-white to-blue-50">
            ...
            <div className="space-y-4 max-w-md mx-auto lg:mr-0 lg:ml-auto mb-8">
              {locations.map((location, index) => (
                <motion.button
                  ...
                  viewport={{ once: true }}
                  className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 w-full rounded-2xl py-4 px-6 text-white text-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl border-2 border-green-200 group"
                  onMouseEnter={() => setHoveredLocation(index)}
                  onMouseLeave={() => setHoveredLocation(null)}
                >
                  <a href='https://technostationery.com/nos-points-de-vente' className="flex items-center justify-center gap-3">
